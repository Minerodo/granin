...
<form:form name="frrc" id="frrc" method="POST" action="" commandName="planilla">
    <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="form-group">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <form:input path="bodeguero.id" hidden="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <form:input path="fecha" onfocusout="agregar('fecha','fh',false);" class="form-control" placeholder="Fecha" min="${catorcena.fecha_inicio}" max="${catorcena.fecha_fin}" type="date" required="true" readonly="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-6 col-md-12">
                ...
                <form:input path="empleado.nombre" onfocusout="agregar_desde_lista('empleado.nombre', 'emp', 'listEmpleado', true);" class="form-control" list="listEmpleado" placeholder="Empleado" type="text" required="true" readonly="true"/>
    ...
    <div class="col-xs-12 col-md-6">
        <div class="form-group">
            <div class="col-xs-12 col-sm-6 col-md-12">
                ...
                <form:input path="cliente.nombre" onfocusout="agregar_desde_lista('cliente.nombre', 'cl', 'listCliente', false);" class="form-control" list="listCliente" placeholder="Cliente" type="text" required="true" readonly="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-6 col-md-12">
                ...
                <form:input path="centro_de_costo.descripcion" onfocusout="agregar_desde_lista('centro_de_costo.descripcion', 'cdc', 'listCentroDeCosto', true);" class="form-control" list="listCentroDeCosto" placeholder="Centro de Costo" type="text" required="true" readonly="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-6 col-md-3 col-md-offset-2">
                ...
                <form:input path="hora_entrada" class="form-control" onchange="calcular();" placeholder="Hora de Entrada" type="time" required="true" readonly="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-6 col-md-3 col-md-offset-2">
                ...
                <form:input path="hora_salida" class="form-control" onchange="calcular();" placeholder="Hora de Salida" type="time" required="true" readonly="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-3  col-md-3 col-md-offset-2">
                ...
                <form:input path="tiempo_receso_horas" class="form-control" onchange="calcular();" placeholder="Horas" type="number" required="true" readonly="true"/>
        ...
        <div class="form-group">
            <div class="col-xs-3 col-md-3 col-md-offset-2">
                ...
                <form:input path="tiempo_receso_minutos" class="form-control" onchange="calcular();" placeholder="Minutos" type="number" required="true" readonly="true"/>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="col-xs-3 col-md-3 col-lg-3">
            <div class="form-group">
                <div class="col-md-9 col-md-offset-3 col-lg-9 col-lg-offset-2">
                    Fase
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="col-xs-3 col-md-3 col-lg-3">
                    <div class="col-md-9 col-md-offset-1 col-lg-9 col-lg-offset-1">
                        <div class="form-group">
                            <input value="${phd.fase.fase}" name="planilla_hora_detalle[${status.index}].fase.fase" onfocusout="seleccionarFase(${statuc.index})" list="listFase" class="form-control" id="planilla_hora_detalle${status.index}.fase.fase" required="true" type="text" placeholder="Fase">
                        </div>
                    </div>
                </div>
...
<datalist id="listCentroDeCosto">
    <c:forEach var="centro_de_costo" items="${centro_de_costos}">
        <option value="${centro_de_costo.centro_de_costo.proyecto.descripcion}" data-ejemplo="${centro_de_costo.centro_de_costo.centro_de_costo}"/>
    </c:forEach>
</datalist>
