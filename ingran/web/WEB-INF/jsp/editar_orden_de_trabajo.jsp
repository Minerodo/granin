...
<form:form name="frrc" id="frrc" method="POST" action="" commandName="odt">
    ...
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        <div class="btn-group" role="group" aria-label="First Group">
            ...
            <input type="submit" name="close" class="btn btn-success" value="Guardar y Cerrar">
...
<div id="id01" class="modal">
    ...
    <form:form class="modal-content animate" name="frrc" id="frrc" method="POST" action="" commandName="odtd">
        <div class="container">
            ...
            <div class="form-group col-xs-1">
                <form:label path="fase.fase">Unidad:</form:label>
                <form:input path="fase.fase" class="form-control" type="text" list="listFase" required="true" readonly="true" />
                <form:errors path="fase.fase"/>
            </div>
            <div class="form-group col-xs-1">
...
<datalist id="listFase">
    <c:forEach var="fase" items="${fases}">
        <option value="${fase.fase}" label="${fase.descripcion}"/>
    </c:forEach>
</datalist>
