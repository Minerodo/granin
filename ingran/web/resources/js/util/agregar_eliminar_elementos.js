$(document).ready(function () {
    ...
    $(addButton).click(function () {
        if (x < maxField) {
            x++;
            var fieldHTML = '<div class="col-md-12"><div class="col-md-1"><a href="javascript:void(0);" class="remove_button btn btn-danger" id="" title="Remove field">Eliminar</a></div><div class="col-md-11"><div class="col-md-2"><div class="form-group"><input name="planilla_hora_detalle[' + y + '].fase.fase" onfocusout="seleccionar(' + y + ')" list="listFase" class="form-control" id="planilla_hora_detalle' + y + '.fase.fase" required="true" type="text" placeholder="Fase"></div></div><div class="col-md-2"><div class="form-group"><input name="planilla_hora_detalle[' + y + '].fase.nombre" class="form-control" id="planilla_hora_detalle' + y + '.fase.nombre" required="true" type="text" placeholder="Descripcion de la Fase" readonly="true"></div></div><div class="col-md-1"><div class="form-group"><input name="planilla_hora_detalle[' + y + '].hora_inicio" class="form-control" id="planilla_hora_detalle' + y + '.hora_inicio" required="true" onchange="calc(' + y + ');" type="time" placeholder="Tipo de Hora"></div></div><div class="col-md-2"><div class="form-group"><input name="planilla_hora_detalle[' + y + '].hora_fin" class="form-control" id="planilla_hora_detalle' + y + '.hora_fin" required="true" onchange="calc(' + y + ');" type="time" placeholder="Tipo de Hora"></div></div><div class="col-md-2"><div class="form-group"><input name="planilla_hora_detalle[' + y + '].tipo_de_hora.tipo_de_hora" class="form-control" id="planilla_hora_detalle' + y + '.tipo_de_hora.tipo_de_hora" required="true" type="text" placeholder="Tipo de Hora"></div></div><div class="col-md-2"><div class="form-group"><input name="planilla_hora_detalle[' + y + '].horas" class="form-control" id="planilla_hora_detalle' + y + '.horas" required="true" type="text" readonly="readonly"></div></div></div></div>';
